...
~/ascat/gw6/bin/generate_affy_geno_cluster.pl apt_norm/birdseed.calls.txt apt_norm/birdseed.confidences.txt apt_norm/quant-norm.pm-only.med-polish.expr.summary.txt -locfile ~/ascat/gw6/lib/affygw6.hg19.pfb -sexfile file_sex -out gw6.genocluster

~/ascat/gw6/bin/normalize_affy_geno_cluster.pl gw6.genocluster apt_norm/quant-norm.pm-only.med-polish.expr.summary.txt -locfile ~/ascat/gw6/lib/affygw6.hg19.pfb -out norm_lrr_baf.txt
