...
~/ascat/gw6/bin/normalize_affy_geno_cluster.pl gw6.genocluster apt_tumor/quant-norm.pm-only.med-polish.expr.summary.txt -locfile ~/ascat/gw6/lib/affygw6.hg19.pfb -out tumor_lrr_baf.txt
